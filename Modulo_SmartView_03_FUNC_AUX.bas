...
Public Function SmartView_Options_MemberOptions_Indent_None(vNombreHoja As Variant) As Long
    ...
    If SmartView_Options_MemberOptions_Indent_None = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Member Options > Indent = None"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Member Options > Indent = None." & vbCrLf & "Error Number = " & SmartView_Options_MemberOptions_Indent_None
    End If
End Function
...
Public Function SmartView_Options_DataOptions_Supress_Missing(vNombreHoja As Variant, vTrueFalse As Boolean) As Long
    ...
    If SmartView_Options_DataOptions_Supress_Missing = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Missing = False"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Data Options > Supress Missing = False." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_Supress_Missing
    End If
...
Public Function SmartView_Options_DataOptions_Supress_Zero(vNombreHoja As Variant, vTrueFalse As Boolean) As Long
    ...
    If SmartView_Options_DataOptions_Supress_Zero = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Zero = False"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Zero = False." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_Supress_Zero
    End If
...
Public Function SmartView_Options_DataOptions_Supress_Repeated(vNombreHoja As Variant, vTrueFalse As Boolean) As Long
    ...
    If SmartView_Options_DataOptions_Supress_Repeated = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Repeated = False"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Repeated = False." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_Supress_Repeated
    End If
End Function
Public Function SmartView_Options_DataOptions_Supress_Invalid(vNombreHoja As Variant, vTrueFalse As Boolean) As Long
    ...
    If SmartView_Options_DataOptions_Supress_Invalid = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Invalid = False"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress Invalid = False." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_Supress_Invalid
    End If
...
Public Function SmartView_Options_DataOptions_Supress_NoAccess(vNombreHoja As Variant, vTrueFalse As Boolean) As Long
    ...
    If SmartView_Options_DataOptions_Supress_NoAccess = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress NoAccess = False"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Data Options > Supress NoAccess = False." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_Supress_NoAccess
    End If
End Function
...
Public Function SmartView_Options_DataOptions_CellDisplay(vNombreHoja As Variant) As Long
    ...
    If SmartView_Options_DataOptions_CellDisplay = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Data Options > Cell Display = Data"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Data Options > Cell Display = Data." & vbCrLf & "Error Number = " & SmartView_Options_DataOptions_CellDisplay
    End If
End Function
...
Public Function SmartView_Options_MemberOptions_DisplayNameOnly(vNombreHoja As Variant) As Long
    ...
    If SmartView_Options_MemberOptions_DisplayNameOnly = 0 Then
        MsgBox "Se establecio con exito la opcion " & vbCrLf & "SmartView > Options > Member Options > Member Display = Name Only"
    Else
        MsgBox "Hubo un error al intentar establecer la opcion " & vbCrLf & "SmartView > Options > Member Options > Member Display = Name Only." & vbCrLf & "Error Number = " & SmartView_Options_MemberOptions_DisplayNameOnly
    End If
End Function
