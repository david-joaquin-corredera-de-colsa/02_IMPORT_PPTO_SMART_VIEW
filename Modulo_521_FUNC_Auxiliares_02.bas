...
Public Function F005_Proteger_Hoja_Contra_Escritura(ByVal vNombreHoja As String) As Boolean
    ...
    ' Inicialización
    strFuncion = "F005_Proteger_Hoja_Contra_Escritura" 'La funcion Caller es valida solo desde Excel 2000, para Excel 97 usariamos: strFuncion = "F005_Proteger_Hoja_Contra_Escritura"
